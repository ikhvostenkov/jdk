...
public final class javac extends java.util.ListResourceBundle {
    protected final Object[][] getContents() {
        return new Object[][] {
            ...
            { "javac.msg.bug", "An exception has occurred in the compiler ({0}). Please file a bug at the Java Bug Database (http://bugreport.java.com/bugreport/) after checking the database for duplicates. Include your program and the following diagnostic in your report.  Thank you." },
            ...
            { "javac.opt.Xlint.desc.sunapi", "Warn about proprietary API that may be removed in a future release." },
